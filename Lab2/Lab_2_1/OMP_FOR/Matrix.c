...
#pragma omp parallel for firstprivate(dest, firstOp, secondOp)
...
#pragma omp parallel for firstprivate(dest, source)
...
#pragma omp parallel for firstprivate(matrix, fillEl)
...
#pragma omp parallel for firstprivate(result, a,  firstOp, b, secondOp)
...
#pragma omp parallel for firstprivate(result, matrix, scal)
...
double scalarMultiplicationOfVectors(Matrix first, Matrix second) {
    double result = 0;
#pragma omp parallel for firstprivate(first, second) reduction(+:result)
...
#pragma omp parallel for firstprivate(out, in)
